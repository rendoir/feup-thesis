...
let pivot = new THREE.Vector2(338, 622.5);
...
let frame0_0 = new Frame(objectTranslation, translation); frames.push(frame0_0);
...
let frame1_1 = new Frame(objectOrientation, orientation); frame0_3.childFrames.push(frame1_1);
...
let frame2_1 = new Frame(objectTranslation, translation); frame1_0.childFrames.push(frame2_1);
