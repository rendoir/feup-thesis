...
class Storyboard {
    ...
    _initFrames() {
        ...
        let frame1_0 = new Frame(); frame0_3.childFrames.push(frame1_0);
        let frame1_1 = new Frame(); frame0_3.childFrames.push(frame1_1);
        let frame1_2 = new Frame(); frame0_3.childFrames.push(frame1_2);
        let frame1_3 = new Frame(); frame0_3.childFrames.push(frame1_3);
